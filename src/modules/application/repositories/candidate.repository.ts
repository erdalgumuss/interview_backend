...
export class CandidateRepository {
   ...
   */
  public async getInterviewPublicById(
    interviewId: string
  ...
  public async updateCandidate(
    ...
    return ApplicationModel.findByIdAndUpdate(applicationId, updateData, {
      new: true,
    }).exec();
  }
  /**
  ...
  public async getApplicationByEmailAndInterview(
    email: string,
    interviewId: string
  ): Promise<IApplication | null> {
